...
export default function BookCard({ book, action, delay = 0 }: BookCardProps) {
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl overflow-hidden shadow-lg shadow-gray-200/50 border border-gray-100 hover:shadow-xl hover:shadow-gray-200/80 transition-shadow duration-300"
    >
